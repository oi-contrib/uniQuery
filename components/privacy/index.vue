	...
	<view class="container" v-if="show">
		<view class="view">
			...
			<view class="btns">
				...
				<button class="submit" @agreeprivacyauthorization="handleAgree()"
					open-type="agreePrivacyAuthorization">同意</button>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		data() {
			return {
				...
				urlTitle: "《用户隐私保护指引》",
				desc2: "当您点击同意并开始时用产品服务时，即表示你已理解并同意该条款内容，该条款将对您产生法律约束力。如您拒绝，将无法正常使用本小程序。",
				show: false
			}
		},
		mounted() {
